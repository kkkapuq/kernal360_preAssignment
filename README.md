- [이력서 자동생성 프로그램](#이력서-자동생성-프로그램)
- [클래스 계층도 및 동작 흐름](#클래스-계층도-및-동작-흐름)
- [구현 기능](#구현-기능)
    * [ResumeView](#resumeview)
    * [ResumeController](#resumecontroller)
- [입출력 내용](#입출력-내용)
- [개발 도구](#개발-도구)
- [요건 외 추가 구현 사항](#요건-외-추가-구현-사항)
    * [정상적인 날짜 판단](#정상적인-날짜-판단)
    * [입력된 사진 파일의 유효 여부](#입력된-사진-파일의-유효-여부)
    * [학력정보, 경력정보를 입력받을 때 시작연도 기준으로 내림차순 정렬처리](#학력정보-경력정보를-입력받을-때-시작연도-기준으로-내림차순-정렬처리)
    * [UserVO를 생성해 지원자 정보 통합](#UserVO를-생성해-지원자-정보-통합)
...
## 학력정보, 경력정보를 입력받을 때 시작연도 기준으로 내림차순 정렬처리
